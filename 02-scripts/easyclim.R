...
ggsave(
  plot = final_plot,
  file = here("03-output", "birmingham.png"),
  width = 18, height = 14
)
...
ggsave(
  plot = final_plot,
  file = here("03-output", "onati_eus.png"),
  width = 18, height = 14
)
...
# write_rds(tmin, file = here("01-data", "tmin_sevilla.rds"))
# write_rds(tmax, file = here("01-data", "tmax_sevilla.rds"))
# write_rds(prcp, file = here("01-data", "prcp_sevilla.rds"))

df_tmin <- read_rds(file = here("01-data", "tmin_sevilla.rds"))
df_tmax <- read_rds(file = here("01-data", "tmax_sevilla.rds"))
df_prcp <- read_rds(file = here("01-data", "prcp_sevilla.rds"))
...
ggsave(
  plot = final_plot,
  file = here("03-output", "sevilla.png"),
  width = 18, height = 14
)
